...
<div id="app">
                ...
                <div class="header-right">
                    <div class="cart box_1">
                        <a href="checkout.html">
                            <h3><span class="simpleCart_total"> jQuery0.00 </span> (<span id="simpleCart_quantity"
                                                                                          class="simpleCart_quantity"> 0 </span>)<img
                                    src="Assets/images/bag.png" alt=""></h3>
                        </a>
        ...
        <div class="main-content">
            ...
            <div class="products-grid">
                ...
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery329</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery599.8</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery359.6</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery649.99</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery750</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery295.59</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery380</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <a class="product_name" href="single.html">perfectly simple</a>
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery540.6</span></a></p>
                </div>
                <div class="col-md-4 product simpleCart_shelfItem text-center">
                    ...
                    <p><a class="item_add" href="#"><i></i> <span class="item_price">jQuery229.5</span></a></p>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
    ...
    <div class="other-products">
        <div class="container">
            ...
            <ul id="flexiselDemo3">
                <li><a href="single.html"><img src="Assets/images/l1.jpg" class="img-responsive" alt=""/></a>
                    <div class="product liked-product simpleCart_shelfItem">
                        <a class="like_name" href="single.html">perfectly simple</a>
                        <p><a class="item_add" href="#"><i></i> <span class=" item_price">jQuery759</span></a></p>
                    </div>
                </li>
                <li><a href="single.html"><img src="Assets/images/l2.jpg" class="img-responsive" alt=""/></a>
                    <div class="product liked-product simpleCart_shelfItem">
                        <a class="like_name" href="single.html">praising pain</a>
                        <p><a class="item_add" href="#"><i></i> <span class=" item_price">jQuery699</span></a></p>
                    </div>
                </li>
                <li><a href="single.html"><img src="Assets/images/l3.jpg" class="img-responsive" alt=""/></a>
                    <div class="product liked-product simpleCart_shelfItem">
                        <a class="like_name" href="single.html">Neque porro</a>
                        <p><a class="item_add" href="#"><i></i> <span class=" item_price">jQuery329</span></a></p>
                    </div>
                </li>
                <li><a href="single.html"><img src="Assets/images/l4.jpg" class="img-responsive" alt=""/></a>
                    <div class="product liked-product simpleCart_shelfItem">
                        <a class="like_name" href="single.html">equal blame</a>
                        <p><a class="item_add" href="#"><i></i> <span class=" item_price">jQuery499</span></a></p>
                    </div>
                </li>
                <li><a href="single.html"><img src="Assets/images/l5.jpg" class="img-responsive" alt=""/></a>
                    <div class="product liked-product simpleCart_shelfItem">
                        <a class="like_name" href="single.html">perfectly simple</a>
                        <p><a class="item_add" href="#"><i></i> <span class=" item_price">jQuery649</span></a></p>
                    </div>
                </li>
            </ul>
